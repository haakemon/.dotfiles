...
# nix specific stuff
alias nixrebuild="sudo nixos-rebuild --upgrade switch --flake ${NIX_CONFIG_HOME}"
alias nixrebuild-nocache="sudo nixos-rebuild --upgrade --option eval-cache false switch --flake ${NIX_CONFIG_HOME}"
